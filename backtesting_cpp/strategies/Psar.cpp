...
extern "C" {
    ...
    void Psar_execute_backtest(Psar *psar, double inital_acc, double acc_increment, double max_acc) {
        return psar->execute_backtest(inital_acc, acc_increment, max_acc);
    }
